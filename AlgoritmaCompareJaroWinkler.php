...
class AlgoritmaCompareJaroWinkler 
{
...
$jw = new AlgoritmaCompareJaroWinkler();
echo $jw->compare("Salah satu upaya untuk mencapai kebahagiaan dengan bersekolah dan bekerja.","Salah satu usaha untuk membahagiakan kedua orang tua dengan bekerja dan belajar dengan giat");